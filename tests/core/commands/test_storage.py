...
def test_lfs_storage_clean_no_remote(runner, project, client):
    ...
    project_properties.repository.add("*")
...
def test_lfs_storage_clean(runner, project, project_with_remote):
    ...
    project_properties.repository.add("*")
    project_properties.repository.commit("Tracked in lfs")
    project_properties.repository.push("origin", no_verify=True)
...
def test_lfs_migrate(runner, project, client):
    ...
    previous_head = project_properties.repository.head.commit.hexsha
    ...
    assert previous_head != project_properties.repository.head.commit.hexsha
    changed_files = [c.a_path for c in project_properties.repository.head.commit.get_changes()]
