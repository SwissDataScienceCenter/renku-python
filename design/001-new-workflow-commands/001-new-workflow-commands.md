...
[steps...]                  A list of step names or UUIDs to be included in the GroupedRun

[paths...]                  A list of output paths that should be generated by the GroupedRun
...
--include-steps     Whether or not to show details for included steps. Default is to only show
                    the names of steps one level down in a GroupedRun
```
