...
error nor bug here. The user should be able to address these issues.
...
necessarily depend on a wrong input nor can they be classified as a bug. Repeating the same
...
.. automodule:: renku.ui.service.errors
   :members:
   :undoc-members:
   :show-inheritance:
