...
detailed information about how to setup the tab completion for these shalls, please
...
.. note::
   Tab complition of available ``Plans`` only works if the user is executing the command
