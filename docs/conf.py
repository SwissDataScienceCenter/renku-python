...
html_theme_options = {
    ...
    'extra_nav_links': {
        ...
        'renga-python@PyPI': 'https://pypi.python.org/pypi/renga-python/',
    }
}
...
htmlhelp_basename = 'renga-python_namedoc'
...
latex_documents = [
  (master_doc, 'renga-python.tex', u'renga-python Documentation',
...
man_pages = [
    (master_doc, 'renga-python', u'renga-python Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'renga-python', u'renga-python Documentation',
   author, 'renga-python', 'Python API and CLI for the Renga platform',
   'Miscellaneous'),
]
