...
@templates_blueprint.route(
    "/templates.read_manifest", methods=["GET"], provide_automatic_options=False, versions=[V0_9, V1_0, V1_1, V1_2]
)
@handle_common_except
@handle_templates_read_errors
@requires_cache
...
@templates_blueprint.route(
    "/templates.create_project", methods=["POST"], provide_automatic_options=False, versions=[V0_9, V1_0, V1_1, V1_2]
)
@handle_common_except
@handle_templates_create_errors
@accepts_json
