...
@dataset_blueprint.route("/datasets.list", methods=["GET"], provide_automatic_options=False, versions=[V1_0])
@handle_common_except
@requires_cache
@optional_identity
...
@dataset_blueprint.route("/datasets.files_list", methods=["GET"], provide_automatic_options=False, versions=[V1_0])
@handle_common_except
@requires_cache
@optional_identity
...
@dataset_blueprint.route("/datasets.add", methods=["POST"], provide_automatic_options=False, versions=[V1_0])
@handle_common_except
@accepts_json
@requires_cache
@requires_identity
...
@dataset_blueprint.route("/datasets.create", methods=["POST"], provide_automatic_options=False, versions=[V1_0])
@handle_common_except
@accepts_json
@requires_cache
@requires_identity
...
@dataset_blueprint.route("/datasets.remove", methods=["POST"], provide_automatic_options=False, versions=[V1_0])
@handle_common_except
@accepts_json
@requires_cache
@requires_identity
...
@dataset_blueprint.route("/datasets.import", methods=["POST"], provide_automatic_options=False, versions=[V1_0])
@handle_common_except
@accepts_json
@requires_cache
@requires_identity
...
@dataset_blueprint.route("/datasets.edit", methods=["POST"], provide_automatic_options=False, versions=[V1_0])
@handle_common_except
@accepts_json
@requires_cache
@requires_identity
...
@dataset_blueprint.route("/datasets.unlink", methods=["POST"], provide_automatic_options=False, versions=[V1_0])
@handle_common_except
@accepts_json
@requires_cache
@requires_identity
