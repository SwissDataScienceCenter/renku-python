...
@jobs_blueprint.route("/jobs", methods=["GET"], provide_automatic_options=False, versions=[V0_9])
...
@jobs_blueprint.route("/jobs/<job_id>", methods=["GET"], provide_automatic_options=False, versions=[V0_9])
@handle_common_except
@requires_cache
@requires_identity
